...
export const snow = {
  ...
  render: () => {
    ...
    state.forEach((s, i) => {
      context.drawImage(canvas.snowflake, s.x + (perlin(s.x / 256, s.y / 256) - 0.5) * 64, s.y)
    });
  },
};
